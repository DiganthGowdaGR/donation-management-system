...
// File: DonorServiceImpl.java
// Role in MVC: Model - Service implementation
// Design Pattern: Observer - publishes DonationEvent after donor registers
...
public class DonorServiceImpl implements DonorService {
    ...
    // Design Principle: Dependency Inversion - use interfaces
    ...
    public Donor save(Donor donor) {
        ...
        // Design Pattern: Observer - publish event when donor is saved
        eventPublisher.publishEvent(
            new com.donation.patterns.observer.DonationEvent(
                this, saved.getId(), "NEW_DONOR",
                "New donor registered: " + saved.getName()
            )
        );
        return saved;
    }
